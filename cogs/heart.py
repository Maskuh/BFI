...
class heart(commands.Cog):
    ...
    # Data to send with the follow request
        data = {
            "webhook_channel_id": newsletter_channel  # The ID of the target channel in the current server
        }
        dataa = {
            "webhook_channel_id": bot_logs_channel  # The ID of the target channel in the current server
        }
